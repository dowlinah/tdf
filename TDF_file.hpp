#ifndef _TDF_FILE_HPP_
#define _TDF_FILE_HPP_
 ...
 *  @brief Contains the class declaration for the TDFFile
 *    class
 **/
...
class TDFFile {
    public:
         ...
         **/
        TDFFile(MPI_Comm comm, const std::string& name, const std::string& mname="") :
            _mpi_comm(comm)
        {
            ofname = name;
            metaname = mname;
